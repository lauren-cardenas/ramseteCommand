...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        //m_chooser.setDefaultOption("Basic", getBasicCommand());
        m_chooser.addOption("Slalom", getPathweaverCommand(0));
        m_chooser.addOption("Square", getPathweaverCommand(1));
        m_chooser.addOption("Barrel", getPathweaverCommand(2));
  ...
  public Command getPathweaverCommand(int json) {
    ...
    {"output/Slalom.wpilib.json",
    "output/Square.wpilib.json",
    "output/Barrel.wpilib.json"};
